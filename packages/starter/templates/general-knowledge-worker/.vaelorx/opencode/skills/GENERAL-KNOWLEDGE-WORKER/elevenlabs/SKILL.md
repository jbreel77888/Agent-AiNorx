...
python scripts/tts.py speak "Hello, this is VaelorX speaking."
...
```bash
python scripts/tts.py speak "Welcome to the VaelorX Weekly. I'm your host, and today we're diving into autonomous AI agents." \
